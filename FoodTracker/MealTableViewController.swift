...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        loadSampleMeals()
        /*
        Alamofire.request(.GET, "http://localhost/pizzas/")
    ...
    func loadSampleMeals() {
                ...
                for (_,subJson):(String, JSON) in json {
                    ...
                    Alamofire.request(.GET, subJson["photo"].string!)
                        .responseJSON { imgResponse in
                            let mealPhoto = UIImage(data: imgResponse.data!)
                            newMeal?.photo = mealPhoto
                            //add to meals array
        ...
        let listMeals = realm?.objects(MealDB.self)
        ...
        for mealdb in listMeals!{
            ...
            meals.append(Meal(name: mealdb.name, photo: photo, rating: mealdb.rating)!)
